  ...
  <div class="picker-wrap">
    ...
    <div class="picker-top">
      <div class="picker-header">
        <div class="ph-icon"><el-icon :size="15"><Cpu /></el-icon></div>
        <span class="ph-title">选择服务器</span>
        <span class="ph-total">{{ servers.length }} 台 · {{ totalPluginCount }} 个插件</span>
      </div>
    ...
    <div class="list-wrap" v-loading="loading" element-loading-background="transparent">
      ...
      <template v-for="g in displayedGroups" :key="g.type">
        ...
        >
          ...
          <span v-if="s.plugins_count != null" class="srv-count">{{ s.plugins_count }} 个</span>
          <span v-else class="srv-pending">…</span>
...
import { Cpu, Search, ArrowRight } from '@element-plus/icons-vue'
