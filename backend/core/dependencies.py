...
plugin_manager = PluginManager(dependency_handler, task_manager)
mod_manager = ModManager(task_manager)
archive_manager = ArchiveManager(task_manager, mcdr_manager)
